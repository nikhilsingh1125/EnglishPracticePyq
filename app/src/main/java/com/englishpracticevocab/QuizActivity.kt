...
import com.englishpracticevocab.adapter.ViewPagerAdapter
import com.englishpracticevocab.model.QuestionData
import com.englishpracticevocab.model.QuizResultPractice
import com.englishpracticevocab.utils.Constants
import com.englishpracticevocab.model.QuestionWiseModel
...
class QuizActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        InterstitialAd.load(
            this,
            "ca-app-pub-7484865336777284/7977499347",
            adRequest,
        ...
        val database = FirebaseDatabase.getInstance().getReference(type.toString())
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val adapter =
                    ViewPagerAdapter(this@QuizActivity, questions, type, category, type)
       ...
       /* if (type == "0") {
            ...
            database.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val adapter =
                        ViewPagerAdapter(this@QuizActivity, questions, title, category, type)
                    idViewPager.adapter = adapter
                }
            ...
            val database =
                FirebaseDatabase.getInstance().getReference("SSC_CGL_2022/SPELLING_ERROR_2022")
            database.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    loader.visibility = View.GONE
                    val description = dataSnapshot.child("Description").getValue(String::class.java)
...
//                    Log.e(TAG, "onDataChange: $questions")
            ...
            val database =
                FirebaseDatabase.getInstance()
                    .getReference("Chsl_SYNONYMS_2022/SPELLING_ERROR_2022")
            database.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    loader.visibility = View.GONE
                    val description = dataSnapshot.child("Description").getValue(String::class.java)
        ...
        if (type == "MTS_1") {
            ...
            val database =
                FirebaseDatabase.getInstance().getReference("SSC_MTS_2022/SPELLING_ERROR_2022")
            database.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    loader.visibility = View.GONE
                    val description = dataSnapshot.child("Description").getValue(String::class.java)
...
//                    Log.e(TAG, "onDataChange: $questions")
                    ...
                    val adapter = ViewPagerAdapter(
                        this@QuizActivity,
                        questions as java.util.ArrayList<QuestionData>,
                        title,
                        category,
                        type
                    )
...
//                    Log.e(TAG, "onDataChange: $questions")
            ...
            val database = FirebaseDatabase.getInstance().getReference("SSC_CGL_2023/SYNONYMS_2023")
            database.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    loader.visibility = View.GONE
                    val description = dataSnapshot.child("Description").getValue(String::class.java)
...
//            bookmarkData(arrayList)
            if (mInterstitialAd != null) {
                ...
                mInterstitialAd?.fullScreenContentCallback = object : FullScreenContentCallback() {
                    ...
                    override fun onAdDismissedFullScreenContent() {
                        ...
                        val databaseReference = FirebaseDatabase.getInstance()
                            .getReference("QuizResultsPractice/$categoryName")

                        databaseReference.setValue(quizResult)
                            .addOnSuccessListener {
                                loader.visibility = View.GONE
                                val intent =
                                    Intent(this@QuizActivity, QuizSubmitActivity::class.java)
                ...
                val databaseReference =
                    FirebaseDatabase.getInstance().getReference("QuizResultsPractice/$categoryName")
