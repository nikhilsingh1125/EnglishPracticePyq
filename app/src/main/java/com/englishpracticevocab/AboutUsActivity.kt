...
class AboutUsActivity : AppCompatActivity() {
    ...
    private fun handleClicks() {
        ...
        btnGmail.setOnClickListener {
            ...
            intent.data = Uri.parse("mailto:ronakpanwar0001@gmail.com?subject=Seeking Your Suggestions for App Enhancement!&body=Hi ENGLISH VOCAB PRACTICE PYQ \n\nI want to")
            startActivity(intent)
        ...
        btnRating.setOnClickListener {
            val playStoreUrl = "https://play.google.com/store/apps/details?id=com.englishpracticevocab"
