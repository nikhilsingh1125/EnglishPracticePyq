...
import com.englishpracticevocab.ExamQuizsActivity
...
class ExamAdapter(
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        Log.e("updateOptionSelectedUI", "Type_of_question : ${model.type_of_question}")
    ...
    private fun resultUi(model: Question, itemView: View, position: Int) {
        ...
        Log.e("ResultUi", "resultUi: ${model.solutions}", )
